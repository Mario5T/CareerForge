    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          {profileCompletion.missingFields.length > 0 && (
            <CardContent>
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm font-medium text-orange-900">Missing fields:</p>
        ...
        <Card className="mb-6 bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
          <CardHeader>
            ...
            <CardDescription className="text-green-700">
              Your company profile is 100% complete and ready to attract top talent.
            </CardDescription>
          </CardHeader>
        </Card>
      )}
      ...
      <Card className="mt-6 bg-blue-50 border-blue-200">
        ...
        <CardContent className="text-sm text-blue-800">
          <p>
            Your company profile helps candidates learn more about your organization.
